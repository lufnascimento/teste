$(document).ready(function (){
	...
	function goback(){
		var gobackbutton = (`<button style="background: #ff1e1e;" id="goback" class="btn"><div class="title">Voltar</div><i class="fas fa-chevron-left icon" style="top:40%;right: 20px"></i></button>`);
