...
Config = {
     SuspensionConfig = { -- Configuração dos leveis da suspensão a AR
         ...
         permissions = {
             vip_permission = 'perm.mochilastaff', -- Permissao para abrir a suspensao a AR sem precisar ser instalada ( Uso para beneficios VIP )
             install_permission = 'perm.mochilastaff', -- Permissao para instalar a suspensao a AR ( Uso para mecanicos )
         },
