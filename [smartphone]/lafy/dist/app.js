const qn = function () {
  ...
  const Ze = He('isMuted', false),
    ...
    X = js.create({
      ...
      baseURL: 'http://localhost:30120/client',
      headers: {},
    })
  ...
  async function rt(t = [], e = false) {
    ...
    try {
      ...
      Ee.set('Você Não Pode Salvar Esta Musica!🎶')
    }
    Ze.set(false)
    let n = t.shift()
    e && t.push(n)
  ...
  function tl() {
    Ee.set('Bluetooth Desconectado - Alcance Excedido!')
    W.set()
  }
  function It(t) {
    Ke = t
    ...
    return (
      lr(($ = t[6]), C),
      {
        c() {
          ...
          E = w('div')
          S = w('h1')
          S.textContent = 'Ultimas Musicas Reproduzidas'
          v = R()
          C.block.c()
  ...
  function gl(t, e, r) {
    ...
    q(t, Bt, (b) => r(5, (c = b)))
    const d = new Date()
    let p = 'Spotify - YukiMusic'
    d.getHours() >= 12 && d.getHours() <= 18
      ? (p = 'Spotify - YukiMusic')
      : (d.getHours() < 5 || d.getHours() > 18) && (p = 'Spotify - YukiMusic')
    async function _(b) {
