		...
		if not incorda then
			if src.checkItem() then
				...
				if closestPlayer ~= nil then
					TriggerServerEvent('cmg2_animations:sync479', closestPlayer, lib,lib2, anim1, anim2, distans, distans2, height,0,length,spin,controlFlagMe,controlFlagTarget,animFlagTarget)
				else
